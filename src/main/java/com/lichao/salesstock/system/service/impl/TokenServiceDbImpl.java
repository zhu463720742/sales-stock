...
import com.lichao.salesstock.system.model.Dict;
import com.lichao.salesstock.system.service.SysLogService;
import com.lichao.salesstock.system.service.TokenService;
...
public class TokenServiceDbImpl implements TokenService {
    ...
    @Autowired
    private RoleDao.TokenDao tokenDao;
    @Autowired
    ...
    public Token saveToken(LoginUser loginUser) {
        ...
        Dict.TokenModel model = new Dict.TokenModel();
    ...
    public void refresh(LoginUser loginUser) {
        ...
        Dict.TokenModel model = tokenDao.getById(loginUser.getToken());
        model.setUpdateTime(new Date());
        model.setExpireTime(new Date(loginUser.getExpireTime()));
        model.setVal(JSONObject.toJSONString(loginUser));
    ...
    public LoginUser getLoginUser(String jwtToken) {
        ...
        if (uuid != null) {
            Dict.TokenModel model = tokenDao.getById(uuid);
    ...
    private LoginUser toLoginUser(Dict.TokenModel model) {
        if (model == null) {
            return null;
        }
